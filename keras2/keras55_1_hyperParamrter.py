...
def create_hyperparameter():
    ...
    return {'batch_size':batchs, 'optimizer':optimizers, 
            'drop':dropout, 'activation':activation, 'learning_rate':lr,
            'node':node}
...
model = RandomizedSearchCV(keras_model, learning_rate, hyperparameters, cv=3, n_iter=2)
...
print('acc score: ', accuracy_score(y_test, y_pred),'lr : ', learning_rate)
