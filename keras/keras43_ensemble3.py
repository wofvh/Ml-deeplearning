...
x1_train , x1_test , x2_train, x2_test, x3_test,x3_train, y_train, y_test = train_test_split(x1, x2 ,y ,train_size=0.7,
                                                                            random_state=6 )

print(x1.shape, x2.shape, x3.shape)  #(30, 2) (70, 2)
#2.모델구성
...
hist = model.fit([x1_test, x2_test],y_train ,epochs=1000, batch_size=100,
