...
data = pd.read_csv('c:/hoon/cls_data.csv',index_col=0)
...
train_gen = DataGenerator(batch_size=32,df = data, mode = 'train', img_size= img_size)
valid_gen = DataGenerator(batch_size=32, df = data, mode = 'valid',img_size = img_size)
