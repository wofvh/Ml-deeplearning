...
# print(Amo['종가'].corr()) # 상관 계수 확인

Amo["종가"].plot(figsize=(12,6)) 
plt.show() # 'T (degC)'열의 전체 데이터 시각화

plt.figure(figsize=(20,10),dpi=120)
plt.plot(Amo['종가'][0:6*24*365],color="black",linewidth=0.2)
...
x1_train,x1_test,x2_train,x2_test,y_train,y_test =train_test_split(x1,x2,y,shuffle=False,\
    train_size=0.75)
...
model.save_weights("./_test/keras46_1_종가_weights2.h5")
