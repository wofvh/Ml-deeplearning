...
model.add(Dense(85, activation='sigmoid'))               # 출력이 0 or 1으로 나와야되기 때문, 그리고 최종으로 나온 값에 반올림을 해주면 0 or 1 완성
model.add(Dense(95, activation='relu'))               # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음
model.add(Dense(125, activation='relu'))               # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음             # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음
model.add(Dense(95, activation='relu'))               # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음
model.add(Dense(112, activation='relu'))               # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음
