...
col_check = pd.read_csv('D:\study_data\_data\green\\train_input/'+'CASE_01.csv',encoding='utf-8')
col_check2 = pd.read_csv('D:\study_data\_data\green\\train_target/'+'CASE_01.csv',encoding='utf-8')

print(col_check.columns)
print(col_check2.columns)
