...
def lgb_hamus(max_depth, gamma, num_leaves, min_child_samples, min_child_weight, subsample, colsample_bytree, max_bin, reg_lambda, reg_alpha):
    params = {
        'n_estimators': 500,"learning_rate": 0.02,
        'max_depth' : int(round(max_depth)),  #round 반올림 할때 사용  무조건 정수로 바꿔줘야함
        'num_leaves': int(round(num_leaves)),
        'gamma' : int(round(gamma)),   #default 0 / 0~inf
...
# {'target': 0.9912280701754386, 'params': {'colsample_bytree': 0.539607648678829, 'gamma': 10.3203674699878,
# 'max_bin': 271.86005357039016, 'max_depth': 5.114927106108324, 'min_child_samples': 178.1595193695925,
# 'min_child_weight':
# 1.6509605046522489, 'num_leaves': 29.358158441348493, 'reg_alpha': 0.44704106320533515, 
# 'reg_lambda': 9.81096599798641,
# 'subsample': 0.7976712083675999}}